...
function lib:Window(text, preset, closebind)
    ...
    Main.Visible = true
    Main.Image = "rbxassetid://1287459632"--脚本背景图
    ...
    function tabhold:Tab(text)
        ...
        Tab.Active = true
        Tab.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
        ...
        if fs == false then
            ...
            TabTitle.TextColor3 = Color3.fromRGB(0, 56, 168)
            Tab.Visible = true
        end
                ...
                for i, v in next, TabHold:GetChildren() do
                    if v.Name == "TabBtn" then
                        ...
                        TweenService:Create(
                            TabTitle,
                            TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(0, 56, 168)}
                        ):Play()
                    end
                end
            end
        ...
        function tabcontent:Button(text, callback)
            ...
            ButtonTitle.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ButtonTitle.BackgroundTransparency = 1.000
            ButtonTitle.Position = UDim2.new(0.0358126722, 0, 0, 0)
            ButtonTitle.Size = UDim2.new(0, 187, 0, 42)
            ButtonTitle.Font = Enum.Font.Gotham
            ButtonTitle.Text = text
            ButtonTitle.TextColor3 = Color3.fromRGB(0, 56, 168)
                ...
                function()
                    if toggled == false then
                        ...
                        TweenService:Create(
                            FrameToggleCircle,
                            TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                            {BackgroundColor3 = Color3.fromRGB(0, 56, 168)}
                        ):Play()
        ...
        function tabcontent:Slider(text, min, max, start, callback)
            ...
            SliderTitle.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            SliderTitle.BackgroundTransparency = 1.000
            SliderTitle.Position = UDim2.new(0.0358126722, 0, 0, 0)
            SliderTitle.Size = UDim2.new(0, 187, 0, 42)
            SliderTitle.Font = Enum.Font.Gotham
            SliderTitle.Text = text
            SliderTitle.TextColor3 = Color3.fromRGB(0, 56, 168)
            SliderTitle.TextSize = 14.000
            SliderTitle.TextXAlignment = Enum.TextXAlignment.Left

            SliderValue.Name = "SliderValue"
            SliderValue.Parent = Slider
            SliderValue.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ...
            SliderValue.TextColor3 = Color3.fromRGB(0, 56, 168)
        ...
        function tabcontent:Dropdown(text, list, callback)
            ...
            DropdownBtn.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ...
            DropItemHolder.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ...
            for i, v in next, list do
                ...
                Item.Text = v
                Item.TextColor3 = Color3.fromRGB(0, 56, 168)
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            ConfirmBtnTitle.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ...
            ConfirmBtnTitle.TextColor3 = Color3.fromRGB(0, 56, 168)
            ...
            ColorpickerBtn.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ...
            RainbowToggleTitle.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ...
            RainbowToggleTitle.TextColor3 = Color3.fromRGB(0, 56, 168)
            ...
            ColorSelection.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ...
            Hue.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            ...
            HueSelection.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            TextBox.BackgroundColor3 = Color3.fromRGB(0, 56, 168)
            TextBox.BackgroundTransparency = 1.000
            TextBox.Size = UDim2.new(0, 100, 0, 23)
            TextBox.Font = Enum.Font.Gotham
            TextBox.Text = ""
            TextBox.TextColor3 = Color3.fromRGB(0, 56, 168)
